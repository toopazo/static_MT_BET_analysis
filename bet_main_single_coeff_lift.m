function bet_st = bet_main_single_coeff_lift(omega_rpm)
    ...
    % str1        = 'bet_main_single_coeff_lift';
    % str2        = rotortype;
    ...
    lambda_c = 0;
    mu = 0;
    lambda = mt_inflow(CT, mu, TPP_alpha, Vtip, lambda_c);

    Cl = 0.01;
    T_mt = Cl * bet_st.blade_st.rho * bet_st.blade_st.rotArea * ...
        (bet_st.blade_st.Vtip)^2
end
