function [T, Qt, lambda_i] = mt_forces(blade_st)
...
%    CT = x0;
    ...
    % [T, Qt, Pt, Pi, Pc, Po, Pp] = mt_T_Q_P(lambda, blade_st);
    Vc  = lambda_c * Vtip;
    vi  = lambda_i * Vtip;
    [T, Qt, Pt, Pi, Pc, Po, Pp] = mt_T_Q_P(rho, A, sigma, omega, R, Vc, vi, Cd0);
    ...
    function err = funzero(x)
        ...
        Cd0 = blade_st.Cd0;
        [T, Qt, Pt, Pi, Pc, Po, Pp] = mt_T_Q_P(rho, A, sigma, omega, R, Vc, vi, Cd0);
        % [T_mt, Q_mt, P_mt] = mt_T_Q_P(lambda, blade_st);
