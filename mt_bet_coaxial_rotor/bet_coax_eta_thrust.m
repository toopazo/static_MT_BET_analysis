function ...
    ...
    db.coaxu_l0     = coaxu_l0;
    db.coaxl_l0     = coaxl_l0;
    ...
    for i = 1:length(db.dcollpitch_arr)
        ...
        bladecoax_u_st.coaxu_l0 = coaxu_l0;
        bladecoax_u_st.coaxl_l0 = coaxl_l0;

        bladecoax_l_st.coaxu_r0 = coaxu_r0;
        bladecoax_l_st.coaxl_r0 = coaxl_r0;
        bladecoax_l_st.coaxu_l0 = coaxu_l0;
        bladecoax_l_st.coaxl_l0 = coaxl_l0;
